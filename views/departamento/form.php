...
<form id="form" method="post" class="well bs-component col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-12">
    ...
    <input id="pk_departamento_id" name="pk_departamento_id" type="hidden" value="<?= $id ?>">
...
<script>
    $(document).ready(function() {
        ...
        $.post("request/departamento.php", {action: "getById", id: <?= $id ?>}, function (data) {
        ...
        $("#form").on('submit', function(e) {
            ...
            if (isvalid) 
                formAction("request/departamento.php", $(this).serialize(), "?op=list_departamento");
        });

        $("#btn-discard").click(function(e){
            e.preventDefault();
            discardAction("?op=list_departamento");
        });
    });
</script>